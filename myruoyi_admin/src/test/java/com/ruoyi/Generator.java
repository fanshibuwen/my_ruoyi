...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/src/main/java/com/ruoyi/web");      //生成文件的输出目录
        gc.setAuthor("zhaol");                                  //作者
...
// 数据源配置
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/my_ruoyi?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
// dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("zhaolong");
